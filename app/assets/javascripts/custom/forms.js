(function () {
  ...
  App.Forms = {
    ...
    synchronizeInputs: function () {
      ...
      processes =
        "[name='legislation_process[background_color]'], [name='legislation_process[font_color]']";
      banners =
        "[name='banner[background_color]'], [name='banner[font_color]']";
    ...
    summaryCharactersCount: function () {
      $("[name='proposal[translations_attributes][0][summary]']").on(
        "keyup",
        function () {
          var length = $(this).val().length;
          var max_length = $("#summary_counter").data("maximum-length");

          $("#summary_counter").text(max_length - length);
        }
      );
    },
    ...
    initialize: function () {
      ...
      App.Forms.summaryCharactersCount();
    },
  };
}.call(this));
