class User < ApplicationRecord
  ...
  EDUCATIONAL_LEVEL = %w[
    postgraduate
    university
    university_unfinished
    secondary
    secondary_unfinished
    primary
    primary_unfinished].freeze
  ...
  validates :educational_level, presence: true, on: :create
  validates :educational_level, inclusion: { in: EDUCATIONAL_LEVEL }, unless: -> { educational_level.blank? }, on: :create
